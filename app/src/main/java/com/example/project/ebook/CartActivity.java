package com.example.project.ebook;
...
import com.example.project.ebook.Model.Cart;
import com.example.project.ebook.Prevalent.Prevalent;
import com.example.project.ebook.Viewholder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    private void CheckOrderState()
    {
        ...
        ordersRef = FirebaseDatabase.getInstance().getReference().child("Orders").child(Prevalent.onlineuser.getPhone());
